...
<body>
	...
	<%
		...
		if(a==1)
		{
			...
			String Query2 ="select * from sale_return where Bill_no="+billno;
			...
			if(h!=0)
			{
				...
				String Query4 ="delete from sale_return where Bill_no="+billno;
				...
				if(f!=0)
				{
					...
					if(b==1)
					{
							...
							{
								String Query5 ="insert into sale_return values('"+billno+"','"+code[i]+"','"+quantity[i]+"','"+billdate+"')";
								...
								if(g!=1 || j!=1)
								{
									out.println("<script type=\"text/javascript\">");
								   	...
								   	out.println("location='addsalereturn.jsp';");
								   	out.println("</script>");
								}
							}
							out.println("<script type=\"text/javascript\">");
						   	out.println("alert('Sale Return Edited!!!');");

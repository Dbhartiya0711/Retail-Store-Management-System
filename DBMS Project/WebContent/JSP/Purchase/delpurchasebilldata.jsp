...
<body>
	...
	<%
		...
		if(a==1)
		{
			String Query5="select count(*) from purchase_return where Bill_no='"+billno+"';";
			...
			if(rs5.getInt(1) == 0)
			{
				...
				if(h!=0)
				{
					...
					String Query1 ="delete from purchase_details where Bill_no="+billno;
					int f= st2.executeUpdate(Query1);
					if(f!=0)
					{
						String Query4 ="delete from purchase where Bill_no="+billno;
			...
			{
				out.println("<script type=\"text/javascript\">");
			   	out.println("alert('Cannot Delete Bill, Return is Present.');");
			   	out.println("location='purchasebills.jsp';");
			   	out.println("</script>");
			}
		}

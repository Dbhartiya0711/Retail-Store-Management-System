...
<body onload="addField(),checkForReturn();">
...
<nav class="nav1">
  <div class="nav-wrapper head1 indigo">
	...
	<div id="printablearea">
			<h3 class="center">Purchase Bill</h3>
				<br><br>
		...
		<div id="returnbutton"  style="display: none;margin-bottom:3px;float: right;">
			<br>
			<button class="btn blue darken-3 waves-effect waves-light center white-text" style="width: 150px;" onclick="location='../Purchase Return/viewpurchasereturn.jsp?billno=<%=bill %>';" ><span>Returns<i class="material-icons right">visibility</i></span></button>
			<br>
		</div>
	<br>

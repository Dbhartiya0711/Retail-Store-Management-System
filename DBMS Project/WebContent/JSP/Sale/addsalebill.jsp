			...
			else
			{
				...
				%>
						...
						if(co.localeCompare(s)==0)
						{
				    		...
				    		ResultSet rs10= st2.executeQuery(Query10);
				    		rs10.next();
							%>
  ...
  <div class="nav-wrapper head1 indigo">
    ...
    <ul>
     ...
     <a href="../logoutdata.jsp">Sign Out</a>
			...
			<h3 class="center">Add sale Bill</h3>
			<br><br>
			<div >
			<form action="asalebilldata.jsp" class="forms1" method="post">
				<div style="width:1000px;margin: auto;text-align: center;">
		            ...
		            a=a+1;
					%>
					<input id="billno" name="billno" type="text" style="font-size:18px;width: 180px;height: 20px;padding-left: 10px;" required="required" value="<%=a%>">
					&emsp;&emsp;&emsp;
					<label style="font-size: 15px;">Bill Date</label>&ensp;
					<input id="datepicker" name="billdate" type="date" style="font-size:16.7px;width: auto;height: 30px;padding-left: 10px;"  required="required">
					</div>
					...
					<select class="browser-default" onchange="setCustomernamemob()" id="Customercon" name="Customercon" style="font-size:13px;width: auto;height: 30px;padding-left: 10px;background: white;" required="required">
					 ...
					 <div class="input-field col s12 inline" style="margin-left:10px;">
				...
				<table  class="center">
					<tr>
						...
						<input style="font-size:18px;width: 50px;height: 20px;" class="input" id="totalq" type="number" readonly="readonly"></td>
					...
					<tr>
						...
						<input style="font-size:18px;width: 60px;height: 20px;" class="input" id="discount" onchange="setdiscountbynet();"></td>
						<td ></td>
					</tr>
					<tr>
						...
						<input style="font-size:18px;width: 90px;height: 20px;" class="input" name="net" id="net" onchange="setnetbytotal();"></td>
						<td ></td>
						</tr>
				</table>
				</div>

...
<title> Add Purchase Return </title>
	...
	<%
            ...
            if(rs111.getInt(1)<1)
            {
            	out.println("<script type=\"text/javascript\">");
			   	out.println("alert('Cannot add Return until Purchase is Added.');");
  ...
  <div class="nav-wrapper head1 indigo">
    ...
    <ul>
     ...
     <a href="../logoutdata.jsp">Sign Out</a>
			...
			<h3 class="center">Add Purchase Return</h3>
			<br>
			<div class="container">
			<form action="apurchasereturndata.jsp" method="post">
				...
				<div style="margin:0px 50px 0px 200px;display:inline-block;" >
					...
					<select class="browser-default" onchange="setdealeridbybill(),showhide(),addField();" id="billno" name="billno" style="display: inline-block;font-size:15px;width: 150px;height: 30px;" required="required" >
				...
				<br/>
				<div>
				<table id="myTable" style="display:none;" class="center">
				...
				<div>
				<table id="myTable1" style="display:none;" class="center">
				<tr>
				        <td><pre>          </pre>    </td>
				        <td>    </td>
						<td></td>

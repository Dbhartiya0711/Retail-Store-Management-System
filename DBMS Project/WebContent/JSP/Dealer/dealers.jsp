    ...
    <ul>
     ...
     <a href="../logoutdata.jsp">Sign Out</a>
		...
		<div style="margin-left:200px; width:800px;">
			<input type="text" id="myInput1" onkeyup="search([1,2])" placeholder="Search By Name" title="Type in Dealer Name" style="border:solid 1px black;padding-left:6px;width:180px;height: 25px;border-radius:2px;font-size: 16px;margin-bottom: 12px;">
			&emsp;&emsp;
			<input type="text" id="myInput2" onkeyup="search([1,2])" placeholder="Search By Mobile" title="Type in Dealer Mobile" style="border:solid 1px black;padding-left:6px;width:180px;height: 25px;border-radius:2px;font-size: 16px;margin-bottom: 12px;">
		...
		<table id="myTable">
				<tr>
					...
					<th>Contact</th>
					<th>Address</th>
					<th class="admin1 btn blue darken-3 waves-effect waves-light" style="margin:9px 0px 0px 23px;" colspan="2"><i class="material-icons right">add</i><a href="adddealer.jsp"><span class="white-text">Add Dealers</span></a></th>
				</tr>
			<tbody>
				<%
					int i=1;
				...
				<tr>
					...
					<td onclick="confirmation();" class="btn blue darken-3 waves-effect waves-light" style="margin:7px 7px 7px 0px;"><i class="material-icons right">delete</i><a href="deldealerdata.jsp?id=<%=rs.getString(1)%>"><span class="white-text">Delete</span></a></td>
					<td class="btn blue darken-3 waves-effect waves-light" style="margin:7px 7px 7px 0px;"><i class="material-icons right">create</i><a href="editdealer.jsp?id=<%=rs.getString(1)%>"><span class="white-text">Edit</span></a></td>
				</tr>
				<%i++;} %>
			</tbody>
		</table>	

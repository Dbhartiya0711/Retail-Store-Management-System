    ...
    <ul>
     ...
     <a href="../logoutdata.jsp">Sign Out</a>
		...
		<%
			...
			String Query1 ="select * from dealer where id='"+id+"'";
			ResultSet rs=st.executeQuery(Query1);
			rs.next();
			%>
	<div class="container">
			<h3 class="center">Edit Dealer</h3>
			<form action="edealerdata.jsp" class="forms1" method="post">
				...
				<div class="clear" style="height: 108px;">
					...
					<textarea name="add" style="border:ridge 5px;padding-left:6px;float:left;border-radius:7px;font-size: 18px;" rows="5" cols="30"><%=rs.getString(4)%></textarea>
				</div>
				<div class="input-field">
					<label class="label">
						Mobile
